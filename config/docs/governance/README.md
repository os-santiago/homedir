...
### [Label Taxonomy](./LABEL_TAXONOMY.md)
Canonical label definitions, naming conventions, and usage rules for issue and PR management.

**Key Points**:
- English-only canonical labels with namespace prefixes (`type:`, `priority:`, `domain:`, `status:`, `severity:`)
- Every issue requires `type:*` and `priority:*` labels
- Bugs require additional `severity:*` label
- Replaces legacy EN/ES duplicate labels

**Related Documents**:
- [Label Migration Plan](./LABEL_MIGRATION.md) - Migration from legacy to canonical labels
- [Label Triage Guide](./LABEL_TRIAGE_GUIDE.md) - Quick reference for maintainers

**When to Use**: During issue triage, PR labeling, and reporting.
...
2. ✅ Verify issue has required labels: `type:*`, `priority:*` (see [Label Triage Guide](./LABEL_TRIAGE_GUIDE.md))
...
1. ✅ [Label Triage Guide](./LABEL_TRIAGE_GUIDE.md) - How to label issues
2. ✅ [Definition of Ready/Done](./DEFINITION_OF_READY_DONE.md) - Quality standards
3. ✅ [PR Review Policy](./PR_REVIEW_POLICY.md) - Review process
4. ✅ [Merge Safety Checklist](./templates/merge_safety_checklist.md) - Pre-merge validation

Maintainers should also review:

5. 📋 [Label Taxonomy](./LABEL_TAXONOMY.md) - Full label specification
6. 🔄 [Label Migration Plan](./LABEL_MIGRATION.md) - Migration status and tools
7. ⚠️ [Review Exception Protocol](./REVIEW_EXCEPTION_PROTOCOL.md) - Exception handling
8. 🚨 [Break-Glass Runbook](./templates/break_glass_runbook.md) - Emergency procedures
