# HomeDir Documentation (EN)

English is the canonical language for documentation in this repository.
Spanish (`docs/es`) mirrors this tree with either full translations or stubs.
...
- [Persistence Service](architecture/persistence-service.md)
- [Persistence Options](architecture/persistence-options.md)
- [ADR: Persistence Service Centralized](architecture/ADR-2025-09-07-persistence-service-centralized.md)
...
- [HomeDir Badge Library](community/homedir-badge-library.md)
...
- [Agent Notes](ai-context/agent-notes.md)
...
- [Navigation Accessibility](ui/nav-accessibility.md)
- [Mobile Upgrade](ui/mobile-upgrade.md)
- [Home Sections](ui/home-sections.md)
- [UI Architecture (ES canonical, EN stub)](ui/architecture.md)
- [UI Design Tokens (ES canonical, EN stub)](ui/design-tokens.md)
- [UI Regression Checklist (ES canonical, EN stub)](ui/regression-checklist.md)
- [UI Site Map (ES canonical, EN stub)](ui/site-map.md)

## Modules

- [Hackathon Module (ES canonical, EN stub)](modules/hackathon/README.md)
- [New UI Archive](modules/new-ui/README.md)
