...
## Contexto
Homedir necesita escalar a múltiples réplicas y persistir estado compartido. Se evaluaron tres opciones: sidecar, servicio centralizado y object storage.
...
- **Positivas:** escala independiente de Homedir.
