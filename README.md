...
**Homedir** is a unique platform designed to empower modern technical communities, focusing on identity, professional development, and gamification of real work.

## [Documentación en Español](docs/es/README.md)
**Homedir** es una plataforma única diseñada para potenciar comunidades técnicas modernas, centrada en identidad, desarrollo profesional y gamificación del trabajo real.
