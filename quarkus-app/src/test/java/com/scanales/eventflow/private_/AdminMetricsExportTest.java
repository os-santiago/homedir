...
public class AdminMetricsExportTest {
  ...
  public void exportTalksHeaderWhenNoRows() {
    String csv =
        given()
            .when()
            .get("/private/admin/metrics/export?table=talks&q=nomatch")
            .then()
            .statusCode(200)
            .extract()
            .asString();
  ...
  public void exportTalksIncludesLowViewRows() {
    String csv =
        given()
            .when()
            .get("/private/admin/metrics/export?table=talks")
            .then()
            .statusCode(200)
            .extract()
            .asString();
    ...
    java.util.List<String> nonBlank =
        java.util.Arrays.stream(lines).filter(l -> !l.isBlank()).toList();
