...
class AdminCampaignsPageTest {
  ...
  void adminCanOpenCampaignProcessPages() {
    ...
    given()
        ...
        .then()
        .statusCode(200)
        .body(containsString("id=\"campaignsChannelsStartPanel\""))
        .body(containsString("id=\"campaignsPublisherPanel\""))
        .body(containsString("id=\"campaignsChooseChannelBtn-discord\""))
        .body(containsString("id=\"campaignsChannelsNextPanel\""))
        .body(containsString("id=\"campaignsChannelAdvancedPanel\""))
