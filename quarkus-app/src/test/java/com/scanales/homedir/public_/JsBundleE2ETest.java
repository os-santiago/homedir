...
public class JsBundleE2ETest {
  ...
  void coreBundleIsLargerThanMinimumSize() {
    ...
    assertTrue(body.length() > 10000,
        "core-bundle.js should be at least 10KB, got " + body.length());
  }
  ...
  void communityBundleIsLargerThanMinimumSize() {
    ...
    assertTrue(body.length() > 50000,
        "community-bundle.js should be at least 50KB, got " + body.length());
  }
  ...
  void homePageIncludesCoreBundleNotIndividualScripts() {
    String html = given()
        ...
        .statusCode(200)
        .extract().asString();
    assertTrue(html.contains("/js/core-bundle.js"),
        "home page should reference core-bundle.js");
    assertTrue(!html.contains("/js/homedir.js"),
        "home page should NOT reference individual homedir.js");
    assertTrue(!html.contains("/js/app.js"),
        "home page should NOT reference individual app.js");
  }
  ...
  void communityPageIncludesCommunityBundleNotIndividualScripts() {
    String html = given()
        ...
        .statusCode(200)
        .extract().asString();
    assertTrue(html.contains("/js/community-bundle.js"),
        "community page should reference community-bundle.js");
    assertTrue(!html.contains("/js/home-lightning.js"),
        "community page should NOT reference home-lightning.js");
    assertTrue(!html.contains("/js/community-content.js"),
        "community page should NOT reference community-content.js");
    assertTrue(!html.contains("/js/community-submissions.js"),
  ...
  void homePageBootstrapRunsBeforeCoreBundle() {
    ...
    assertTrue(bootstrapIndex < bundleIndex,
        "bootstrap must appear before core-bundle.js");
  }
