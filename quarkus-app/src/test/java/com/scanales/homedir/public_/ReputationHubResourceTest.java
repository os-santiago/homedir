...
class ReputationHubResourceTest {
  ...
  void reputationHubPreservesAndEscapesFullLinkedNameInTitle() {
    ...
    userProfileService.linkGithub(
        ...
        new UserProfile.GithubAccount(
            ...
            Instant.parse("2026-03-01T00:00:00Z")));
    assertTrue(
        reputationEngineService.trackQuestCompleted("hub.long.name@example.com", "long-name"));

    String escaped =
        "Long Community Member ".repeat(6) + "&quot;Builder&quot; &amp; &lt;Helper&gt;";
    given()
        .header("Accept-Language", "en")
        .when()
        .get("/comunidad/reputation-hub")
        ...
        .body(
            containsString(
                "class=\"hub-member-link\" title=\"" + escaped + "\">" + escaped + "</a>"))
  ...
  void reputationHubRendersPlaceholderAvatarWhenUserHasNoAvatarOrHandle() {
    ...
    given()
        ...
        .body(
            containsString(
                "class=\"hub-member-name\" title=\"noavatar@example.com\">noavatar@example.com</span>"))
        .body(containsString("hub-avatar-fallback"));
  }
}
