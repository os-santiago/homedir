...
public class Talk {
  ...
  /**
   * Sanitizes talk names by replacing control characters with spaces, stripping unsupported symbols
   * and normalizing whitespace. The result is truncated to {@link #MAX_NAME_LENGTH} characters.
   */
