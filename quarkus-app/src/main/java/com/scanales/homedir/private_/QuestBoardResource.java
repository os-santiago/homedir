...
public class QuestBoardResource {
  ...
  public static class Templates {
    public static native TemplateInstance quests(
        List<Quest> quests, String filter, UserSession userSession);
  }
    ...
    if ("mine".equalsIgnoreCase(filter)) {
      ...
      if (userId != null) {
        ...
        if (profileOpt.isPresent()) {
          ...
          var activeQuests =
              profile.getActiveQuests() != null ? profile.getActiveQuests() : List.<String>of();
