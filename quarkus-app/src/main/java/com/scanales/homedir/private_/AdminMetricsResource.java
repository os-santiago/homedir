...
import com.scanales.homedir.service.UsageMetricsService.Health;
import com.scanales.homedir.service.UsageMetricsService.Summary;
...
public class AdminMetricsResource {
  ...
  public Response persistence() {
    ...
    stats.put("economy", economyService.metrics());
  ...
  private boolean belongsToEvent(String stageId, String eventId) {
    com.scanales.homedir.model.Event ev = eventService.findEventByScenario(stageId);
