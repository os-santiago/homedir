...
public class ProfileResource {
  ...
  static class Templates {
    static native TemplateInstance profile(
        ...
        long attendedTalks,
        long ratedTalks,
        com.scanales.homedir.model.UserProfile.GithubAccount github,
        com.scanales.homedir.model.UserProfile.DiscordAccount discord,
  ...
  private java.util.List<ClassProgress> buildClassProgress(
      com.scanales.homedir.model.UserProfile userProfile, int fallbackXp) {
    ...
    return eventService.listEvents().stream()
        ...
        .sorted(
            Comparator.comparing(
                com.scanales.homedir.model.Event::getDate,
