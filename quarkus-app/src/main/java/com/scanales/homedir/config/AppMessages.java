...
public interface AppMessages {
  ...
  @Message(
      "Apply as volunteer for {eventTitle}. Selected members collaborate with the organizing team before event day.")
  ...
  @Message(
      "Tell us about your background, your motivation, and what makes your contribution unique.")
  ...
  @Message(
      "Use the lounge to review announcements, ask questions, and coordinate with organizers and volunteers.")
  ...
  @Message(
      "Selected volunteers can post updates, ask questions, and share coordination notes here.")
  ...
  @Message(
      "For panel format, add up to 4 panelists. Linked accounts will be assigned as speakers after acceptance.")
  ...
  @Message(
      "This CFP flow is currently in testing mode. Submissions are considered test data and are not part of a formal process for this event.")
  ...
  @Message(
      "Submissions are closed while the organizing team reviews proposals and prepares the next round of updates.")
  ...
  @Message(
      "The team is consolidating decisions and will publish results as soon as they are ready.")
  ...
  @Message(
      "Review the selected talks and stay tuned for final delivery guidance and slide deadlines.")
  ...
  @Message(
      "Follow the event agenda and use the CFP page as a reference point for what was selected.")
  ...
  @Message(
      "Visit the official sponsorship page for {eventTitle} to review the available opportunities.")
  ...
  @Message(
      "Timeline from CFP opening to event days. Segment width is proportional to each stage duration.")
  ...
  @Message(
      "Toggle a public warning on the CFP submission form so attendees know this is a test flow.")
  ...
  @Message(
      "Control submission window, event-specific limits, and optional testing override for this event.")
  ...
  @Message(
      "Keep internal decisions hidden while proposals stay under review publicly, then publish the final outcome for everyone at once.")
  ...
  @Message(
      "Add or remove event-scoped reviewers by email so they can read the CFP queue without full Homedir admin access.")
  ...
  @Message(
      "Are you sure you want to accept this submission? The speaker will be notified that their talk was accepted.")
  String events_cfp_admin_confirm_accept_message();

  @Message(
      "Are you sure you want to reject this submission? The submission will move to the rejected state and the user will be informed.")
  ...
  @Message(
      "Toggle a public warning on event agendas so attendees know this schedule is still a category-based proposal.")
  ...
  @Message(
      "One place to track real status, active features, releases, and delivery signals for homedir.")
  ...
  @Message(
      "This is an open source project built on voluntary contributions as a learning and practice space for the community.")
  ...
  @Message(
      "Here you can see global alerts about updates in available event schedules. Mark as read or remove notifications you no longer need.")
  ...
  @Message(
      "by OpenSourceSantiago — Community platform to scale your open source teams and projects.")
  String home_tagline();
  ...
  @Message(
      "Start with one account, connect your contribution signals, and turn community activity into visible progress.")
  String home_p0_subtitle();

  @Message(
      "See the community, events, and project in one place, then unlock your profile, classes, HCoin, and rewards.")
  String home_p0_intro_guest();

  @Message(
      "Your account is live. Keep building momentum by linking signals, voting on picks, and joining the next event.")
  ...
  @Message(
      "Create your HomeDir account and keep your preferences, profile, and progress in one place.")
  ...
  @Message(
      "Link GitHub and Discord so your public profile reflects where you participate and contribute.")
  ...
  @Message(
      "Vote on picks, explore events, and move through the community with quick actions that compound.")
  ...
  @Message(
      "Gain XP, HCoin, classes, and rewards that make your profile more credible and more shareable.")
  ...
  @Message(
      "The landing stays focused, but the product now has stronger loops across profile, community, and event participation.")
  ...
  @Message(
      "Complete short verified routes, gain XP and HCoin, and unlock public cards worth sharing.")
  ...
  @Message(
      "{count} recent curated signals are already live across AI, platform engineering, cloud native, and security.")
  ...
  @Message(
      "{memberCount} HomeDir members can already build a visible profile with linked community signals.")
  ...
  @Message(
      "Finish these three actions to activate your contributor setup and unlock the XP + HCoin already attached to each step.")
  ...
  @Message(
      "Use this short panel as your daily starting point: finish setup, review what changed, and spend your progress deliberately.")
  ...
  @Message(
      "Your first vote is still pending. One quick pick review is enough to start your feed signal.")
  ...
  @Message(
      "No upcoming events yet. Use the directory to review the event space and watch for updates.")
  ...
  @Message(
      "You have {balance} HCoin and {catalogCount} rewards available to inspect or unlock next.")
  ...
  @Message(
      "No curated picks are visible yet. Open Community Picks to explore the feed and help shape what appears next.")
  ...
  @Message(
      "No featured events are visible yet. Open the events directory to browse the current timeline and published agendas.")
  ...
  @Message(
      "See where your activity is really accumulating so your profile feels intentional, not random.")
  ...
  @Message(
      "Your class map will start filling as soon as you vote, connect signals, and move through the community.")
  ...
  @Message(
      "Use this panel to decide whether you should keep saving, buy the next reward, or push your profile into a new tier.")
  ...
  @Message(
      "This reward is already unlocked. It costs {priceHcoin} HCoin and you currently hold {balanceHcoin}.")
  ...
  @Message(
      "Use this space as the shortest way to notice changes that matter to your profile, events, and community flow.")
  ...
  @Message(
      "Event updates, CFP news, and community signals will appear here as soon as they start moving.")
  ...
  @Message(
      "Three quick actions are enough to understand what moved today and keep your profile momentum growing on purpose.")
  ...
  @Message(
      "No new picks landed in the last 24h, but one quick review still keeps your feed signal intentional.")
  ...
  @Message(
      "No unread notifications right now. A quick check still keeps you synced with new changes.")
  ...
  @Message(
      "{count} event entries are currently visible. Review the agenda space before something changes.")
  ...
  @Message(
      "{count} fresh lightning threads are visible right now. Use LTA for a quick community pulse.")
  String home_p3_loop_action_lta_desc(int count);

  @Message(
      "No fresh lightning threads landed in the last 24h. Open LTA and set the next quick pulse yourself.")
  ...
  @Message(
      "One sharp statement or question at a time. Keep it concise, react fast, and surface the best answer.")
  ...
  @Message(
      "1 post per hour per account. Replies: 1 per minute per account. Keep it concise: 100 chars for posts, 200 for replies.")
  ...
  @Message(
      "Choose the path that matches what you need today: follow DevOpsDays Santiago, read local and regional community updates, or contribute through the open calls.")
  ...
  @Message(
      "Start with the next community event and use HomeDir as the operating space for agenda, CFP, volunteers, and event updates.")
  ...
  @Message(
      "Follow curated news about community building, regional events, DevRel, open source, and local ecosystem activity.")
  ...
  @Message(
      "Pick one contribution path for DevOpsDays Santiago. Each path leads directly to the relevant action.")
  ...
  @Message(
      "Explore a lightweight 2D isometric map and jump into Community, Events, Project, and Profile.")
  String beta_hero_desc();

  @Message(
      "Experimental MVP. We are testing a low-overhead gamified navigation loop before scaling.")
  ...
  @Message(
      "This policy describes how HomeDir processes personal data for community identity, events, and collaboration features in Chile.")
  ...
  @Message(
      "HomeDir, operated by the OpenSourceSantiago community, processes account identity data, linked integration metadata (Google/GitHub/Discord), usage activity signals, and content submitted by users.")
  ...
  @Message(
      "Data is processed to operate accounts, events, CFP workflows, community interactions, moderation, security controls, and service metrics, based on user consent, service operation needs, and legitimate security interests.")
  ...
  @Message(
      "Data is stored in persistent systems managed by HomeDir operators with backups, access controls, and operational safeguards. Some integrations may involve international providers selected by users.")
  ...
  @Message(
      "When users connect external providers, HomeDir receives only required metadata for enabled features and does not sell personal data. Limited processing by technical operators may occur under platform operation duties.")
  ...
  @Message(
      "Users can request access, correction, deletion, portability, and objection where applicable, and can unlink integrations. Requests can be submitted through official community channels and the contact page (/contacto).")
  ...
  @Message(
      "By using HomeDir, users accept these terms and agree to responsible use aligned with community purpose and applicable Chilean law.")
  ...
  @Message(
      "Users must not abuse APIs, disrupt services, automate spam, bypass security controls, or publish harmful/illegal content. Community moderation and safety rules are mandatory.")
  ...
  @Message(
      "Users are responsible for safeguarding linked accounts and actions under authenticated identity. HomeDir may limit or suspend access to protect platform integrity and community safety.")
  ...
  @Message(
      "Users retain ownership of submitted content and grant HomeDir a non-exclusive permission to store, moderate, and display it inside platform features. Content that violates rules may be restricted or removed.")
  ...
  @Message(
      "HomeDir is an evolving service. Operators may apply maintenance windows, quotas, and operational controls. Service continuity is managed with best effort and no uninterrupted availability guarantee.")
  ...
  @Message(
      "These terms may be updated and become effective when published on this page. HomeDir publishes relevant service conditions transparently and applies Chilean law, with jurisdiction in Santiago, Chile.")
  ...
  @Message(
      "HomeDir: your community to build, learn, and share through events, projects, and curated content.")
  ...
  @Message(
      "This is a temporary agenda proposal based on 2026 market categories. Final talks and activities will be updated after the CFP selection process.")
  ...
  @Message(
      "Who participates, where they collaborate from, and how they share their community presence.")
  ...
  @Message(
      "Link your accounts to improve your visibility across HomeDir, GitHub, and Discord groups.")
  ...
  @Message(
      "Connect Discord to appear in the Community Board, enrich your public profile, and unlock community signals tied to your account.")
  ...
  @Message("Delete all metrics data? This action cannot be undone.")
  ...
  @Message(
      "Start here if you only want to publish a platform update or product novelty without navigating the full operational depth.")
  ...
  @Message(
      "Review the available drafts, filter them, and keep only the items you want to move into publication.")
  ...
  @Message(
      "Enable only the channels you want to use and prepare the pilot channel before publishing.")
  ...
  @Message(
      "Review the final message pack, schedule the selected draft, and trigger the publish scan when the channel is ready.")
  ...
  @Message(
      "Track visits, audit events, and any publication issue without mixing that context with draft selection.")
  ...
  @Message(
      "Use the board when you want one visual dashboard for draft, ready, scheduled, published, and blocked campaigns.")
  ...
  @Message(
      "Follow the sequence below to publish a HomeDir update with the least possible friction.")
  ...
  @Message(
      "Choose one of the existing drafts or narrow the queue with filters until only the message you want to publish remains.")
  ...
  @Message(
      "Review the available channels, keep only the channel you will use, and confirm the pilot if needed.")
  ...
  @Message(
      "Inspect the message preview, schedule the draft, and run publication only when the channel is ready.")
  ...
  @Message(
      "Use the monitoring page to review traffic, audit trail, and any recovery action after publication.")
  ...
  @Message(
      "Track the state of each campaign at a glance and open the detail page only when you need to act.")
  ...
  @Message(
      "Use this page only for the final publication step: schedule, preview, publish, and confirm manual LinkedIn handoffs.")
  ...
  @Message(
      "Review GA readiness, route health, recognition evidence, and the remaining pre-GA checklist from one admin page.")
  ...
  @Message(
      "Use this list to close the most important blocker first instead of reading every raw metric.")
  ...
  @Message(
      "A compact product pulse that explains where users are active, which actions are happening, and where delivery or UX friction needs attention.")
  ...
  @Message(
      "Use standard types for cleaner analytics (PR_OPENED, PR_MERGED, PR_VALIDATION_PASSED, PRODUCTION_VERIFIED).")
  ...
  @Message(
      "Insights events are captured automatically from product flows and delivery pipelines. Manual append is disabled.")
  ...
  @Message("PR validations passed (last 7d)")
  String admin_insights_js_status_pr_validation_passed_7d();

  @Message("PR validations failed (last 7d)")
  String admin_insights_js_status_pr_validation_failed_7d();

  @Message("PR validation success rate (last 7d)")
  String admin_insights_js_status_pr_validation_success_rate_7d();
  ...
  @Message(
      "Join our support channel on Discord for help with events, CFP, volunteering, or anything else.")
