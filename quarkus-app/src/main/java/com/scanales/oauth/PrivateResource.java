...
/**
 * OAuth-protected resource that shows the authenticated user's information. It now lives under
 * "/private" so it does not clash with other endpoints.
 */
@Path("/private")
public class PrivateResource {
  ...
  public static class Templates {
    public static native TemplateInstance privatePage(
        String sub,
